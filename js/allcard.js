  ...
  for (let i = 0; i < link.length; i++) {
    if (link[i].startsWith("text=")) {
      link[i] =
        ...
        "गीता प्रिय " +
        memberName +
        " जी %0A🌹जय श्री कृष्ण🌹%0A" +
        encodeURIComponent(newText) +
        " %0A %0ATo view profile Click here- " +
        "https://parivaar.gieogita.org/member.php?member=" +
        myhash;
      break;
    }
  }
