...
while ($row = mysqli_fetch_array($result)) {
    echo '
                    <div class="grid-item p-2 position-relative">
                        ...
                        <button id = '. $row["id"] . '"  type="button" class="cls btn-close myacisdjfs;l position-absolute" data-bs-custom-class="custom-tooltip" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Close"></button>
