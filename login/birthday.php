...
<body>
    ...
    <div class="container">
        <div class="row my-3 ">
                ...
                <form class="mt-3 bg-warning-subtle px-2 rounded shadow-sm" action="" method="POST">
                    <div class="row selecting d-flex flex-wrap bg-warning-subtle gap-1 p-1">
                        ...
                        <input type="number" name="birthDate" class="form-control form-control-sm  inputfields"
                            placeholder="Enter Date" aria-label="First name" oninput="validateDate(this)" required>


                        <input type="number" name="birthMonth" class="form-control form-control-sm inputfields"
                            placeholder="Enter Month" aria-label="Last name" oninput="validateMonth(this)" required>
            ...
            <div class="col-md overflow-x-scroll">
