    ...
    <form method="POST" action="submit.php" id="joinForm">
      <div>
        ...
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          ...
          <input autocapitalize="words" name="name" id="name" type="text" maxlength="50" class="form-control" onkeypress="return blockNumbers(event)">
        </div>
        <div class="bg-warning-subtle p-2 py-2 rounded">
          <label class="form-label form-label-sm" for="phone">WhatsApp Number(without country code)</label>
          <input id="phoneNum" name="phone" size="10" minlength="10" maxlength="10" type="text" class="form-control" inputmode="numeric" pattern="[0-9]*" onkeypress="return blockChars(event)" required>
        </div>
        <div class="bg-warning-subtle p-2 py-2 rounded ">
        ...
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          ...
          <select id="dikshit" name="dikshit" class="form-select " aria-label="Small select example" required>
        ...
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          ...
          <select id="stateSelect" name="state" class="form-select " aria-label="Small select example" onchange="loadDistrict(this)" disabled required>
            <option selected>--------</option>
          </select>
        </div>
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          <label for="citySelect" class="form-label form-label-sm">Select District</label>
          <select id="citySelect" name="district" class="form-select " aria-label="Small select example" onchange="loadTehsil(this)" disabled required>
            <option selected>---------</option>
          </select>
        </div>
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          <label class="form-label form-label-sm" for="tehsilSelect">Select Tehsil</label>
          <select id="tehsilSelect" name="tehsil" class="form-select " aria-label="Small select example" disabled required>
            <option selected>--------</option>
          </select>
        </div>
        ...
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          ...
          <select name="occupation" id="occupation" class="form-select " aria-label="Small select example" required>
        ...
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          ...
          <select name="education" id="education" class="form-select " aria-label="Small select example" required>
        ...
        <div class="bg-warning-subtle p-2 py-2 rounded ">
          ...
          <select name="married" id="married" class="form-select " onchange="aniver()" required>
